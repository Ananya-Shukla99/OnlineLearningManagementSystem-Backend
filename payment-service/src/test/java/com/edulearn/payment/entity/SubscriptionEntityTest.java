...
class SubscriptionEntityTest {
    ...
    void testSubscriptionBuilder() {
        ...
        assertEquals(1L, builtSubscription.getSubscriptionId());
        assertEquals(5L, builtSubscription.getStudentId());
    ...
    void testSetAndGetStudentId() {
        // Act
        subscription.setStudentId(5L);

        // Assert
        assertEquals(5L, subscription.getStudentId());
    }
    ...
    void testFullSubscriptionCreation() {
        ...
        // Assert
        assertEquals(1L, fullSubscription.getSubscriptionId());
        assertEquals(5L, fullSubscription.getStudentId());
