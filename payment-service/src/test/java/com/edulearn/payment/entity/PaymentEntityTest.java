...
class PaymentEntityTest {
    ...
    void testPaymentBuilder() {
        ...
        assertEquals(1L, builtPayment.getPaymentId());
        assertEquals(10L, builtPayment.getStudentId());
        assertEquals(5L, builtPayment.getCourseId());
    ...
    void testSetAndGetStudentId() {
        // Act
        payment.setStudentId(5L);

        // Assert
        assertEquals(5L, payment.getStudentId());
    }
    ...
    void testSetAndGetCourseId() {
        ...
        // Assert
        assertEquals(10L, payment.getCourseId());
    }
