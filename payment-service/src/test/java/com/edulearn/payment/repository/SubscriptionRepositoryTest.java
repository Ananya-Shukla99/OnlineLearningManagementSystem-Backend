...
class SubscriptionRepositoryTest {
    ...
    void testFindByStudentIdAndStatus() {
        ...
        // Act
        Optional<Subscription> foundSubscription = subscriptionRepository.findByStudentIdAndStatus(1L, "ACTIVE");
    ...
    void testFindByStudentIdAndStatusNotFound() {
        ...
        // Act
        Optional<Subscription> foundSubscription = subscriptionRepository.findByStudentIdAndStatus(1L, "CANCELLED");
