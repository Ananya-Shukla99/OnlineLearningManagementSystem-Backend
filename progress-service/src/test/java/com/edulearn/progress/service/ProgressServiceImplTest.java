...
class ProgressServiceImplTest {
    ...
    void testTrackProgressUpdateWatchedSeconds() {
        ...
        Progress existingProgress = testProgress.builder()
                .watchedSeconds(300)
                .build();
    ...
    void testGetAllProgressByStudent() {
        ...
        progressList.add(testProgress.builder().progressId(2).lessonId(2).build());
    ...
    void testGetAllCertificatesByStudent() {
        ...
        certificateList.add(testCertificate.builder().certificateId(2).courseId(2).build());
